...
abstract class EntityTestBase extends TMGMTTestBase {
   ...
   */
  function createNodeType($machine_name, $human_name, $entity_translation = FALSE) {
    ...
    if (!$entity_translation) {
      ...
      $this->attachFields('node', $machine_name, FALSE);
    }
    else {
      ...
      $this->attachFields('node', $machine_name, TRUE);
    }
  }
