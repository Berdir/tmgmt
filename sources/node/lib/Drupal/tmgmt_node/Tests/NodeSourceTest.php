...
/**
 * @file
 * Contains Drupal\tmgmt_node\Tests\NodeSourceTest.
 */

namespace Drupal\tmgmt_node\Tests;
 ...
 */
class NodeSourceTest extends EntityTestBase {
   ...
   * @var array
   */
  public static $modules = array('tmgmt_node', 'translation');
